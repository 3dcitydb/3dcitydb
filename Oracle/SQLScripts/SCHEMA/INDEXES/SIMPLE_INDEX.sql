...
CREATE INDEX ADDRESS_OBJCLASS_FKX ON ADDRESS (OBJECTCLASS_ID);
...
CREATE INDEX APPEARANCE_OBJCLASS_FKX ON APPEARANCE (OBJECTCLASS_ID);
...
CREATE INDEX CITYMODEL_OBJECTCLASS_FKX ON CITYMODEL (OBJECTCLASS_ID);
...
CREATE INDEX IMPLICIT_GEOM_OBJCLASS_FKX ON IMPLICIT_GEOMETRY (OBJECTCLASS_ID);
...
CREATE INDEX SCHEMA_REFERENCING_FKX1 ON SCHEMA_REFERENCING (LOCAL_ID);
...
CREATE INDEX TEXPARAM_OBJCLASS_FKX ON TEXTUREPARAM (OBJECTCLASS_ID);
