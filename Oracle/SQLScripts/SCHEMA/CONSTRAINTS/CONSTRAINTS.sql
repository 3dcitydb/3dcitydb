...
ALTER TABLE ADDRESS
ADD CONSTRAINT ADDRESS_OBJECTCLASS_FK FOREIGN KEY
(
  OBJECTCLASS_ID 
)
...
ALTER TABLE APPEARANCE
ADD CONSTRAINT APPEARANCE_OBJCLASS_FK FOREIGN KEY
(
  OBJECTCLASS_ID 
)
REFERENCES OBJECTCLASS
...
ALTER TABLE BREAKLINE_RELIEF
ADD CONSTRAINT BREAKLINE_REL_OBJCLASS_FK FOREIGN KEY
(
  OBJECTCLASS_ID 
)
REFERENCES OBJECTCLASS
...
ALTER TABLE BRIDGE
ADD CONSTRAINT BRIDGE_OBJECTCLASS_FK FOREIGN KEY
(
  OBJECTCLASS_ID 
)
REFERENCES OBJECTCLASS
...
ALTER TABLE BRIDGE_CONSTR_ELEMENT
ADD CONSTRAINT BRIDGE_CONSTR_OBJCLASS_FK FOREIGN KEY
(
  OBJECTCLASS_ID 
)
REFERENCES OBJECTCLASS
...
ALTER TABLE BRIDGE_FURNITURE
ADD CONSTRAINT BRIDGE_FURN_OBJCLASS_FK FOREIGN KEY
(
  OBJECTCLASS_ID 
)
REFERENCES OBJECTCLASS
...
ALTER TABLE BRIDGE_ROOM
ADD CONSTRAINT BRIDGE_ROOM_OBJCLASS_FK FOREIGN KEY
(
  OBJECTCLASS_ID 
)
REFERENCES OBJECTCLASS
...
ALTER TABLE BUILDING
ADD CONSTRAINT BUILDING_OBJECTCLASS_FK FOREIGN KEY
(
  OBJECTCLASS_ID 
)
REFERENCES OBJECTCLASS
...
ALTER TABLE BUILDING_FURNITURE
ADD CONSTRAINT BLDG_FURN_OBJCLASS_FK FOREIGN KEY
(
  OBJECTCLASS_ID 
)
REFERENCES OBJECTCLASS
...
ADD CONSTRAINT CITYMODEL_OBJECTCLASS_FK FOREIGN KEY
(
  OBJECTCLASS_ID 
)
REFERENCES OBJECTCLASS
...
ALTER TABLE CITYOBJECTGROUP
ADD CONSTRAINT GROUP_OBJECTCLASS_FK FOREIGN KEY
(
  OBJECTCLASS_ID 
)
REFERENCES OBJECTCLASS
...
ALTER TABLE CITY_FURNITURE
ADD CONSTRAINT CITY_FURN_OBJCLASS_FK FOREIGN KEY
(
  OBJECTCLASS_ID 
)
REFERENCES OBJECTCLASS
...
ALTER TABLE GENERIC_CITYOBJECT
ADD CONSTRAINT GEN_OBJECT_OBJCLASS_FK FOREIGN KEY
(
  OBJECTCLASS_ID 
)
REFERENCES OBJECTCLASS
...
ALTER TABLE IMPLICIT_GEOMETRY
ADD CONSTRAINT IMPLICIT_GEOM_OBJCLASS_FK FOREIGN KEY
(
  OBJECTCLASS_ID 
)
REFERENCES OBJECTCLASS
...
ALTER TABLE LAND_USE
ADD CONSTRAINT LAND_USE_OBJCLASS_FK FOREIGN KEY
(
  OBJECTCLASS_ID 
)
REFERENCES OBJECTCLASS
...
ALTER TABLE MASSPOINT_RELIEF
ADD CONSTRAINT MASSPOINT_REL_OBJCLASS_FK FOREIGN KEY
(
  OBJECTCLASS_ID 
)
REFERENCES OBJECTCLASS
...
ADD CONSTRAINT OBJECTCLASS_ADE_FK FOREIGN KEY
(
  ADE_ID 
)
REFERENCES ADE
...
ALTER TABLE OBJECTCLASS
ADD CONSTRAINT OBJECTCLASS_BASECLASS_FK FOREIGN KEY
(
  BASECLASS_ID 
)
REFERENCES OBJECTCLASS
...
ALTER TABLE PLANT_COVER
ADD CONSTRAINT PLANT_COVER_OBJCLASS_FK FOREIGN KEY
(
  OBJECTCLASS_ID 
)
REFERENCES OBJECTCLASS
...
ALTER TABLE RELIEF_FEATURE
ADD CONSTRAINT RELIEF_FEAT_OBJCLASS_FK FOREIGN KEY
(
  OBJECTCLASS_ID 
)
REFERENCES OBJECTCLASS
...
ALTER TABLE ROOM
ADD CONSTRAINT ROOM_OBJECTCLASS_FK FOREIGN KEY
(
  OBJECTCLASS_ID 
)
REFERENCES OBJECTCLASS
...
ALTER TABLE SCHEMA
ADD CONSTRAINT SCHEMA_ADE_FK FOREIGN KEY
(
  ADE_ID 
)
REFERENCES ADE
...
ADD CONSTRAINT SCHEMA_REFERENCING_FK1 FOREIGN KEY
(
  REFERENCING_ID 
)
REFERENCES SCHEMA
...
ALTER TABLE SCHEMA_REFERENCING
ADD CONSTRAINT SCHEMA_REFERENCING_FK2 FOREIGN KEY
(
  REFERENCED_ID 
)
REFERENCES SCHEMA
...
ADD CONSTRAINT SCHEMA_TO_OBJECTCLASS_FK1 FOREIGN KEY
(
  SCHEMA_ID 
)
REFERENCES SCHEMA
...
ALTER TABLE SCHEMA_TO_OBJECTCLASS
ADD CONSTRAINT SCHEMA_TO_OBJECTCLASS_FK2 FOREIGN KEY
(
  OBJECTCLASS_ID 
)
REFERENCES OBJECTCLASS
...
ALTER TABLE SOLITARY_VEGETAT_OBJECT
ADD CONSTRAINT SOL_VEG_OBJ_OBJCLASS_FK FOREIGN KEY
(
  OBJECTCLASS_ID 
)
REFERENCES OBJECTCLASS
...
ALTER TABLE TEXTUREPARAM
ADD CONSTRAINT TEXPARAM_OBJCLASS_FK FOREIGN KEY
(
  OBJECTCLASS_ID 
)
REFERENCES OBJECTCLASS
...
ALTER TABLE TIN_RELIEF
ADD CONSTRAINT TIN_RELIEF_OBJCLASS_FK FOREIGN KEY
(
  OBJECTCLASS_ID 
)
REFERENCES OBJECTCLASS
...
ALTER TABLE TUNNEL
ADD CONSTRAINT TUNNEL_OBJECTCLASS_FK FOREIGN KEY
(
  OBJECTCLASS_ID 
)
REFERENCES OBJECTCLASS
...
ALTER TABLE TUNNEL_FURNITURE
ADD CONSTRAINT TUNNEL_FURN_OBJCLASS_FK FOREIGN KEY
(
  OBJECTCLASS_ID 
)
REFERENCES OBJECTCLASS
...
ALTER TABLE TUNNEL_HOLLOW_SPACE
ADD CONSTRAINT TUN_HSPACE_OBJCLASS_FK FOREIGN KEY
(
  OBJECTCLASS_ID 
)
REFERENCES OBJECTCLASS
...
ALTER TABLE WATERBODY
ADD CONSTRAINT WATERBODY_OBJCLASS_FK FOREIGN KEY
(
  OBJECTCLASS_ID 
)
REFERENCES OBJECTCLASS
