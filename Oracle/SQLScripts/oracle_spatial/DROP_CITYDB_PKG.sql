...
--
SELECT 'Deleting packages ''citydb_util'', ''citydb_idx'', ''citydb_srs'', ''citydb_stat'', ''citydb_delete_by_lineage'', ''citydb_delete'' and corresponding types' as message from DUAL;
...
SELECT 'Packages ''citydb_util'', ''citydb_idx'', ''citydb_srs'', ''citydb_stat'', ''citydb_delete_by_lineage'', and ''citydb_delete'' deleted' as message from DUAL;