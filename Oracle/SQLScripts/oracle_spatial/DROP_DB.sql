...
ALTER TABLE RASTER_RELIEF DROP CONSTRAINT "RASTER_RELIEF_COVERAGE_FK";
...
DROP TABLE GRID_COVERAGE CASCADE CONSTRAINTS;
DROP TABLE GRID_COVERAGE_RDT CASCADE CONSTRAINTS;
...
DROP SEQUENCE GRID_COVERAGE_RDT_SEQ;
