...
ALTER TABLE RASTER_RELIEF DROP CONSTRAINT "RASTER_RELIEF_COMP_FK";
ALTER TABLE RASTER_RELIEF DROP CONSTRAINT "RASTER_RELIEF_GEORAST_FK";
...
ALTER TABLE TUNNEL_INSTALLATION DROP CONSTRAINT "TUNNEL_INST_HAPACE_FK";
...
DROP TABLE RASTER_RELIEF_GEORASTER CASCADE CONSTRAINTS;
DROP TABLE RASTER_REL_GEORASTER_RDT CASCADE CONSTRAINTS;
