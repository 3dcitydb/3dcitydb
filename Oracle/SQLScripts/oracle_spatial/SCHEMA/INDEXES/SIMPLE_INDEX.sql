...
CREATE INDEX ADDRESS_TO_BRIDGE_FKX1 ON ADDRESS_TO_BRIDGE (BIRDGE_ID);
...
CREATE INDEX RASTER_RELIEF_GEORAST_FKX ON RASTER_RELIEF (GEORASTER_ID);
...
CREATE UNIQUE INDEX SURFACE_GEOM_INX ON SURFACE_GEOMETRY (GMLID);
