...
AS
  ...
  procedure delete_room(pid number, schema_name varchar2 := USER);
  ...
  procedure delete_city_furniture(pid number, schema_name varchar2 := USER);
  procedure delete_generic_cityobject(pid number, schema_name varchar2 := USER);
  procedure delete_land_use(pid number, schema_name varchar2 := USER);
  procedure delete_plant_cover(pid number, schema_name varchar2 := USER);
  procedure delete_solitary_veg_obj(pid number, schema_name varchar2 := USER);
  procedure delete_transport_complex(pid number, schema_name varchar2 := USER);
  procedure delete_traffic_area(pid number, schema_name varchar2 := USER);
  procedure delete_waterbnd_surface(pid number, schema_name varchar2 := USER);
  procedure delete_waterbody(pid number, schema_name varchar2 := USER);
  procedure delete_relief_feature(pid number, schema_name varchar2 := USER);
  procedure delete_relief_component(pid number, schema_name varchar2 := USER);
  procedure delete_tin_relief(pid number, schema_name varchar2 := USER);
  procedure delete_masspoint_relief(pid number, schema_name varchar2 := USER);
  procedure delete_breakline_relief(pid number, schema_name varchar2 := USER);
  procedure delete_raster_relief(pid number, schema_name varchar2 := USER);
  procedure delete_bridge(pid number, schema_name varchar2 := USER);
  ...
  procedure delete_bridge_opening(pid number, schema_name varchar2 := USER);
  ...
  procedure delete_tunnel_thematic_surface(pid number, schema_name varchar2 := USER);
...
AS
  ...
  procedure delete_room(room_rec room%rowtype, schema_name varchar2 := USER);
  procedure delete_building_furniture(building_furniture_rec building_furniture%rowtype, schema_name varchar2 := USER);
  procedure delete_building(building_rec building%rowtype, schema_name varchar2 := USER);
  procedure delete_city_furniture(city_furniture_rec city_furniture%rowtype, schema_name varchar2 := USER);
  procedure delete_generic_cityobject(generic_cityobject_rec generic_cityobject%rowtype, schema_name varchar2 := USER);
  procedure delete_land_use(land_use_rec land_use%rowtype, schema_name varchar2 := USER);
  procedure delete_plant_cover(plant_cover_rec plant_cover%rowtype, schema_name varchar2 := USER);
  procedure delete_solitary_veg_obj(solitary_veg_obj_rec solitary_vegetat_object%rowtype, schema_name varchar2 := USER);
  procedure delete_traffic_area(traffic_area_rec traffic_area%rowtype, schema_name varchar2 := USER);
  procedure delete_transport_complex(transport_complex_rec transportation_complex%rowtype, schema_name varchar2 := USER);
  procedure delete_waterbody(waterbody_rec waterbody%rowtype, schema_name varchar2 := USER);
  procedure delete_waterbnd_surface(waterbnd_surface_rec waterboundary_surface%rowtype, schema_name varchar2 := USER);
  procedure delete_relief_feature(relief_feature_rec relief_feature%rowtype, schema_name varchar2 := USER);
  procedure delete_relief_component(relief_component_rec relief_component%rowtype, schema_name varchar2 := USER);
  procedure delete_tin_relief(tin_relief_rec tin_relief%rowtype, schema_name varchar2 := USER);
  procedure delete_masspoint_relief(masspoint_relief_rec masspoint_relief%rowtype, schema_name varchar2 := USER);
  procedure delete_breakline_relief(breakline_relief_rec breakline_relief%rowtype, schema_name varchar2 := USER);
  procedure delete_raster_relief(raster_relief_rec raster_relief%rowtype, schema_name varchar2 := USER);
  procedure delete_bridge(bridge_rec bridge%rowtype, schema_name varchar2 := USER);
  procedure delete_bridge_thematic_surface(bridge_thematic_surface_rec bridge_thematic_surface%rowtype, schema_name varchar2 := USER);
  procedure delete_bridge_installation(bridge_installation_rec bridge_installation%rowtype, schema_name varchar2 := USER);
  procedure delete_bridge_room(bridge_room_rec bridge_room%rowtype, schema_name varchar2 := USER);
  procedure delete_bridge_furniture(bridge_furniture_rec bridge_furniture%rowtype, schema_name varchar2 := USER);
  procedure delete_bridge_opening(bridge_opening_rec bridge_opening%rowtype, schema_name varchar2 := USER);
  procedure delete_bridge_constr_element(bridge_constr_element_rec bridge_constr_element%rowtype, schema_name varchar2 := USER);
  procedure delete_tunnel(tunnel_rec tunnel%rowtype, schema_name varchar2 := USER);
  procedure delete_tunnel_thematic_surface(tunnel_thematic_surface_rec tunnel_thematic_surface%rowtype, schema_name varchar2 := USER);
  procedure delete_tunnel_installation(tunnel_installation_rec tunnel_installation%rowtype, schema_name varchar2 := USER);
  procedure delete_tunnel_hollow_space(tunnel_hollow_space_rec tunnel_hollow_space%rowtype, schema_name varchar2 := USER);
  procedure delete_tunnel_furniture(tunnel_furniture_rec tunnel_furniture%rowtype, schema_name varchar2 := USER);
  procedure delete_tunnel_opening(tunnel_opening_rec tunnel_opening%rowtype, schema_name varchar2 := USER);
  ...
  procedure pre_del_bridge_thematic_srf(bridge_thematic_surface_rec bridge_thematic_surface%rowtype, schema_name varchar2 := USER);
  procedure post_del_bridge_thematic_srf(bridge_thematic_surface_rec bridge_thematic_surface%rowtype, schema_name varchar2 := USER);
  procedure post_delete_bridge_inst(bridge_installation_rec bridge_installation%rowtype, schema_name varchar2 := USER);
  procedure post_del_bridge_constr_element(bridge_constr_element_rec bridge_constr_element%rowtype, schema_name varchar2 := USER);
  ...
  procedure pre_del_tunnel_thematic_srf(tunnel_thematic_surface_rec tunnel_thematic_surface%rowtype, schema_name varchar2 := USER);
  procedure post_del_tunnel_thematic_srf(tunnel_thematic_surface_rec tunnel_thematic_surface%rowtype, schema_name varchar2 := USER);
  procedure post_delete_tunnel_inst(tunnel_installation_rec tunnel_installation%rowtype, schema_name varchar2 := USER);
  procedure pre_del_tunnel_hollow_space(tunnel_hollow_space_rec tunnel_hollow_space%rowtype, schema_name varchar2 := USER);
  procedure post_del_tunnel_hollow_space(tunnel_hollow_space_rec tunnel_hollow_space%rowtype, schema_name varchar2 := USER);
  ...
  */
  ...
  begin
    ...
    execute immediate 'delete from ' || schema_name || '.implicit_geometry where id=:1' using pid;
  ...
  begin
    if implicit_geometry_rec.relative_brep_id is not null then
      intern_delete_surface_geometry(implicit_geometry_rec.relative_brep_id, schema_name);
    end if;
  exception
    when others then
  ...
  */
  ...
  is
  begin
    execute immediate 'delete from ' || schema_name || '.grid_coverage where id=:1' using pid;
  exception
    when others then
  ...
  */
  ...
  begin
    ...
    execute immediate 'delete from ' || schema_name || '.cityobject where id=:1' using pid;
  exception
    when others then
  ...
  */
  ...
  begin
    ...
    execute immediate 'delete from ' || schema_name || '.appearance where id=:1' using appearance_rec.id;
  exception
    when others then
  ...
  */
  ...
  begin
    ...
    execute immediate 'delete from ' || schema_name || '.surface_data where id=:1' using surface_data_rec.id;
  exception
    when others then
  ...
  */
  ...
  begin
    if cityobjectgroup_rec.brep_id is not null then
      intern_delete_surface_geometry(cityobjectgroup_rec.brep_id, schema_name);
    end if;  

    intern_delete_cityobject(cityobjectgroup_rec.id, schema_name);
  exception
    when others then
  ...
  */
  ...
  begin
    ...
    execute immediate 'delete from ' || schema_name || '.thematic_surface where id=:1' using thematic_surface_rec.id;
  ...
  begin
    if thematic_surface_rec.lod2_multi_surface_id is not null then
      intern_delete_surface_geometry(thematic_surface_rec.lod2_multi_surface_id, schema_name);
    end if;
    if thematic_surface_rec.lod3_multi_surface_id is not null then
      intern_delete_surface_geometry(thematic_surface_rec.lod3_multi_surface_id, schema_name);
    end if;
    if thematic_surface_rec.lod4_multi_surface_id is not null then
      intern_delete_surface_geometry(thematic_surface_rec.lod4_multi_surface_id, schema_name);
    end if;

    intern_delete_cityobject(thematic_surface_rec.id, schema_name);
  exception
    when others then
  ...
  */
  ...
  begin
    ...
    execute immediate 'delete from ' || schema_name || '.opening where id=:1' using opening_rec.id;
  ...
  begin
    ...
    if opening_rec.lod4_multi_surface_id is not null then
      intern_delete_surface_geometry(opening_rec.lod4_multi_surface_id, schema_name);
    end if;
    ...
    intern_delete_cityobject(opening_rec.id, schema_name);
  exception
    when others then
  ...
  */
  ...
  is
  begin
    execute immediate 'delete from ' || schema_name || '.building_installation where id=:1' using building_installation_rec.id;
  ...
  begin
    if building_installation_rec.lod2_brep_id is not null then
      intern_delete_surface_geometry(building_installation_rec.lod2_brep_id, schema_name);
    end if;
    if building_installation_rec.lod3_brep_id is not null then
      intern_delete_surface_geometry(building_installation_rec.lod3_brep_id, schema_name);
    end if;
    if building_installation_rec.lod4_brep_id is not null then
      intern_delete_surface_geometry(building_installation_rec.lod4_brep_id, schema_name);
    end if;

    intern_delete_cityobject(building_installation_rec.id, schema_name);
  exception
    when others then
  ...
  */
  ...
  begin
    ...
    execute immediate 'delete from ' || schema_name || '.room where id=:1' using room_rec.id;
  ...
  begin
    if room_rec.lod4_multi_surface_id is not null then
      intern_delete_surface_geometry(room_rec.lod4_multi_surface_id, schema_name);
    end if;
    if room_rec.lod4_solid_id is not null then
      intern_delete_surface_geometry(room_rec.lod4_solid_id, schema_name);
    end if;

    intern_delete_cityobject(room_rec.id, schema_name);
  exception
    when others then
  ...
  */
  ...
  is
  begin
    execute immediate 'delete from ' || schema_name || '.building_furniture where id=:1' using building_furniture_rec.id;
  ...
  */
  ...
  begin
    ...
    execute immediate 'delete from ' || schema_name || '.building where id=:1' using building_rec.id;
  ...
  begin
    if building_rec.lod0_footprint_id is not null then
      intern_delete_surface_geometry(building_rec.lod0_footprint_id, schema_name);
    end if; 
    if building_rec.lod0_roofprint_id is not null then
      intern_delete_surface_geometry(building_rec.lod0_roofprint_id, schema_name);
    end if;
  
    if building_rec.lod1_multi_surface_id is not null then
      intern_delete_surface_geometry(building_rec.lod1_multi_surface_id, schema_name);
    end if; 
    if building_rec.lod2_multi_surface_id is not null then
      intern_delete_surface_geometry(building_rec.lod2_multi_surface_id, schema_name);
    end if;
    if building_rec.lod3_multi_surface_id is not null then
      intern_delete_surface_geometry(building_rec.lod3_multi_surface_id, schema_name);
    end if;
    if building_rec.lod4_multi_surface_id is not null then
      intern_delete_surface_geometry(building_rec.lod4_multi_surface_id, schema_name);
    end if;

    if building_rec.lod1_solid_id is not null then
      intern_delete_surface_geometry(building_rec.lod1_solid_id, schema_name);
    end if; 
    if building_rec.lod2_solid_id is not null then
      intern_delete_surface_geometry(building_rec.lod2_solid_id, schema_name);
    end if;
    if building_rec.lod3_solid_id is not null then
      intern_delete_surface_geometry(building_rec.lod3_solid_id, schema_name);
    end if;
    if building_rec.lod4_solid_id is not null then
      intern_delete_surface_geometry(building_rec.lod4_solid_id, schema_name);
    end if;
    
    intern_delete_cityobject(building_rec.id, schema_name);
  exception
    when others then
  ...
  */
  ...
  is
  begin
    execute immediate 'delete from ' || schema_name || '.city_furniture where id=:1' using city_furniture_rec.id;
  ...
  begin
    if city_furniture_rec.lod1_brep_id is not null then
      intern_delete_surface_geometry(city_furniture_rec.lod1_brep_id, schema_name);
    end if; 
    if city_furniture_rec.lod2_brep_id is not null then
      intern_delete_surface_geometry(city_furniture_rec.lod2_brep_id, schema_name);
    end if;
    if city_furniture_rec.lod3_brep_id is not null then
      intern_delete_surface_geometry(city_furniture_rec.lod3_brep_id, schema_name);
    end if;
    if city_furniture_rec.lod4_brep_id is not null then
      intern_delete_surface_geometry(city_furniture_rec.lod4_brep_id, schema_name);
    end if;

    intern_delete_cityobject(city_furniture_rec.id, schema_name);
  exception
    when others then
  ...
  */
  ...
  is
  begin
    execute immediate 'delete from ' || schema_name || '.generic_cityobject where id=:1' using generic_cityobject_rec.id;
  ...
  begin
    if generic_cityobject_rec.lod0_brep_id is not null then
      intern_delete_surface_geometry(generic_cityobject_rec.lod0_brep_id, schema_name);
    end if; 
    if generic_cityobject_rec.lod1_brep_id is not null then
      intern_delete_surface_geometry(generic_cityobject_rec.lod1_brep_id, schema_name);
    end if; 
    if generic_cityobject_rec.lod2_brep_id is not null then
      intern_delete_surface_geometry(generic_cityobject_rec.lod2_brep_id, schema_name);
    end if;
    if generic_cityobject_rec.lod3_brep_id is not null then
      intern_delete_surface_geometry(generic_cityobject_rec.lod3_brep_id, schema_name);
    end if;
    if generic_cityobject_rec.lod4_brep_id is not null then
      intern_delete_surface_geometry(generic_cityobject_rec.lod4_brep_id, schema_name);
    end if;

    intern_delete_cityobject(generic_cityobject_rec.id, schema_name);
  exception
    when others then
  ...
  */
  ...
  is
  begin
    execute immediate 'delete from ' || schema_name || '.land_use where id=:1' using land_use_rec.id;
  ...
  begin
    if land_use_rec.lod0_multi_surface_id is not null then
      intern_delete_surface_geometry(land_use_rec.lod0_multi_surface_id, schema_name);
    end if; 
    if land_use_rec.lod1_multi_surface_id is not null then
      intern_delete_surface_geometry(land_use_rec.lod1_multi_surface_id, schema_name);
    end if; 
    if land_use_rec.lod2_multi_surface_id is not null then
      intern_delete_surface_geometry(land_use_rec.lod2_multi_surface_id, schema_name);
    end if;
    if land_use_rec.lod3_multi_surface_id is not null then
      intern_delete_surface_geometry(land_use_rec.lod3_multi_surface_id, schema_name);
    end if;
    if land_use_rec.lod4_multi_surface_id is not null then
      intern_delete_surface_geometry(land_use_rec.lod4_multi_surface_id, schema_name);
    end if;

    intern_delete_cityobject(land_use_rec.id, schema_name);
  exception
    when others then
  ...
  */
  ...
  is
  begin
    execute immediate 'delete from ' || schema_name || '.plant_cover where id=:1' using plant_cover_rec.id;
  ...
  begin
    if plant_cover_rec.lod1_multi_surface_id is not null then
      intern_delete_surface_geometry(plant_cover_rec.lod1_multi_surface_id, schema_name);
    end if; 
    if plant_cover_rec.lod2_multi_surface_id is not null then
      intern_delete_surface_geometry(plant_cover_rec.lod2_multi_surface_id, schema_name);
    end if;
    if plant_cover_rec.lod3_multi_surface_id is not null then
      intern_delete_surface_geometry(plant_cover_rec.lod3_multi_surface_id, schema_name);
    end if;
    if plant_cover_rec.lod4_multi_surface_id is not null then
      intern_delete_surface_geometry(plant_cover_rec.lod4_multi_surface_id, schema_name);
    end if;

    if plant_cover_rec.lod1_multi_solid_id is not null then
      intern_delete_surface_geometry(plant_cover_rec.lod1_multi_solid_id, schema_name);
    end if; 
    if plant_cover_rec.lod2_multi_solid_id is not null then
      intern_delete_surface_geometry(plant_cover_rec.lod2_multi_solid_id, schema_name);
    end if;
    if plant_cover_rec.lod3_multi_solid_id is not null then
      intern_delete_surface_geometry(plant_cover_rec.lod3_multi_solid_id, schema_name);
    end if;
    if plant_cover_rec.lod4_multi_solid_id is not null then
      intern_delete_surface_geometry(plant_cover_rec.lod4_multi_solid_id, schema_name);
    end if;
    
    intern_delete_cityobject(plant_cover_rec.id, schema_name);
  exception
    when others then
  ...
  */
  ...
  is
  begin
    execute immediate 'delete from ' || schema_name || '.solitary_vegetat_object where id=:1' using solitary_veg_obj_rec.id;
  ...
  begin
    if solitary_veg_obj_rec.lod1_brep_id is not null then
      intern_delete_surface_geometry(solitary_veg_obj_rec.lod1_brep_id, schema_name);
    end if; 
    if solitary_veg_obj_rec.lod2_brep_id is not null then
      intern_delete_surface_geometry(solitary_veg_obj_rec.lod2_brep_id, schema_name);
    end if;
    if solitary_veg_obj_rec.lod3_brep_id is not null then
      intern_delete_surface_geometry(solitary_veg_obj_rec.lod3_brep_id, schema_name);
    end if;
    if solitary_veg_obj_rec.lod4_brep_id is not null then
      intern_delete_surface_geometry(solitary_veg_obj_rec.lod4_brep_id, schema_name);
    end if;

    intern_delete_cityobject(solitary_veg_obj_rec.id, schema_name);
  exception
    when others then
  ...
  */
  ...
  is
  begin
    execute immediate 'delete from ' || schema_name || '.traffic_area where id=:1' using traffic_area_rec.id;
  ...
  begin
    if traffic_area_rec.lod2_multi_surface_id is not null then
      intern_delete_surface_geometry(traffic_area_rec.lod2_multi_surface_id, schema_name);
    end if;
    if traffic_area_rec.lod3_multi_surface_id is not null then
      intern_delete_surface_geometry(traffic_area_rec.lod3_multi_surface_id, schema_name);
    end if;
    if traffic_area_rec.lod4_multi_surface_id is not null then
      intern_delete_surface_geometry(traffic_area_rec.lod4_multi_surface_id, schema_name);
    end if;

    intern_delete_cityobject(traffic_area_rec.id, schema_name);
  exception
    when others then
  ...
  */
  ...
  begin
    ...
    execute immediate 'delete from ' || schema_name || '.transportation_complex where id=:1' using transport_complex_rec.id;
  ...
  begin
    if transport_complex_rec.lod1_multi_surface_id is not null then
      intern_delete_surface_geometry(transport_complex_rec.lod1_multi_surface_id, schema_name);
    end if; 
    if transport_complex_rec.lod2_multi_surface_id is not null then
      intern_delete_surface_geometry(transport_complex_rec.lod2_multi_surface_id, schema_name);
    end if;
    if transport_complex_rec.lod3_multi_surface_id is not null then
      intern_delete_surface_geometry(transport_complex_rec.lod3_multi_surface_id, schema_name);
    end if;
    if transport_complex_rec.lod4_multi_surface_id is not null then
      intern_delete_surface_geometry(transport_complex_rec.lod4_multi_surface_id, schema_name);
    end if;

    intern_delete_cityobject(transport_complex_rec.id, schema_name);
  exception
    when others then
  ...
  */
  ...
  begin
    ...
    execute immediate 'delete from ' || schema_name || '.waterbody where id=:1' using waterbody_rec.id;
  ...
  begin
    if waterbody_rec.lod1_solid_id is not null then
      intern_delete_surface_geometry(waterbody_rec.lod1_solid_id, schema_name);
    end if; 
    if waterbody_rec.lod2_solid_id is not null then
      intern_delete_surface_geometry(waterbody_rec.lod2_solid_id, schema_name);
    end if;
    if waterbody_rec.lod3_solid_id is not null then
      intern_delete_surface_geometry(waterbody_rec.lod3_solid_id, schema_name);
    end if;
    if waterbody_rec.lod4_solid_id is not null then
      intern_delete_surface_geometry(waterbody_rec.lod4_solid_id, schema_name);
    end if;
    if waterbody_rec.lod0_multi_surface_id is not null then
      intern_delete_surface_geometry(waterbody_rec.lod0_multi_surface_id, schema_name);
    end if;
    if waterbody_rec.lod1_multi_surface_id is not null then
      intern_delete_surface_geometry(waterbody_rec.lod1_multi_surface_id, schema_name);
    end if;

    intern_delete_cityobject(waterbody_rec.id, schema_name);
  exception
    when others then
  ...
  begin
    ...
    execute immediate 'delete from ' || schema_name || '.waterboundary_surface where id=:1' using waterbnd_surface_rec.id;
  ...
  begin
    if waterbnd_surface_rec.lod2_surface_id is not null then
      intern_delete_surface_geometry(waterbnd_surface_rec.lod2_surface_id, schema_name);
    end if;
    if waterbnd_surface_rec.lod3_surface_id is not null then
      intern_delete_surface_geometry(waterbnd_surface_rec.lod3_surface_id, schema_name);
    end if;
    if waterbnd_surface_rec.lod4_surface_id is not null then
      intern_delete_surface_geometry(waterbnd_surface_rec.lod4_surface_id, schema_name);
    end if;

    intern_delete_cityobject(waterbnd_surface_rec.id, schema_name);
  exception
    when others then
  ...
  */
  ...
  begin
    ...
    execute immediate 'delete from ' || schema_name || '.relief_feature where id=:1' using relief_feature_rec.id;
  ...
  is
  begin
    intern_delete_cityobject(relief_feature_rec.id, schema_name);
  exception
    when others then
  ...
  */
  ...
  begin
    ...
    delete_tin_relief(relief_component_rec.id, schema_name);
    delete_masspoint_relief(relief_component_rec.id, schema_name);
    delete_breakline_relief(relief_component_rec.id, schema_name);
    delete_raster_relief(relief_component_rec.id, schema_name);
  exception
    when others then
  ...
  begin
    ...
    execute immediate 'delete from ' || schema_name || '.relief_component where id=:1' using relief_component_rec.id;
  ...
  is
  begin
    intern_delete_cityobject(relief_component_rec.id, schema_name);
  exception
    when others then
  ...
  */
  ...
  is
  begin
    execute immediate 'delete from ' || schema_name || '.tin_relief where id=:1' using tin_relief_rec.id;
  ...
  begin
    if tin_relief_rec.surface_geometry_id is not null then
      intern_delete_surface_geometry(tin_relief_rec.surface_geometry_id, schema_name);
    end if;
  exception
    when others then
  ...
  */
  ...
  is
  begin
    execute immediate 'delete from ' || schema_name || '.masspoint_relief where id=:1' using masspoint_relief_rec.id;
  ...
  */
  ...
  is
  begin
    execute immediate 'delete from ' || schema_name || '.breakline_relief where id=:1' using breakline_relief_rec.id;
  ...
  */
  ...
  is
  begin
    execute immediate 'delete from ' || schema_name || '.raster_relief where id=:1' using raster_relief_rec.id;
  ...
  is
  begin
    intern_delete_grid_coverage(raster_relief_rec.coverage_id, schema_name);
  exception
    when others then
  ...
  */
  ...
  begin
    ...
    execute immediate 'delete from ' || schema_name || '.bridge where id=:1' using bridge_rec.id;
  ...
  begin
    if bridge_rec.lod1_multi_surface_id is not null then
      intern_delete_surface_geometry(bridge_rec.lod1_multi_surface_id, schema_name);
    end if; 
    if bridge_rec.lod2_multi_surface_id is not null then
      intern_delete_surface_geometry(bridge_rec.lod2_multi_surface_id, schema_name);
    end if;
    if bridge_rec.lod3_multi_surface_id is not null then
      intern_delete_surface_geometry(bridge_rec.lod3_multi_surface_id, schema_name);
    end if;
    if bridge_rec.lod4_multi_surface_id is not null then
      intern_delete_surface_geometry(bridge_rec.lod4_multi_surface_id, schema_name);
    end if;

    if bridge_rec.lod1_solid_id is not null then
      intern_delete_surface_geometry(bridge_rec.lod1_solid_id, schema_name);
    end if; 
    if bridge_rec.lod2_solid_id is not null then
      intern_delete_surface_geometry(bridge_rec.lod2_solid_id, schema_name);
    end if;
    if bridge_rec.lod3_solid_id is not null then
      intern_delete_surface_geometry(bridge_rec.lod3_solid_id, schema_name);
    end if;
    if bridge_rec.lod4_solid_id is not null then
      intern_delete_surface_geometry(bridge_rec.lod4_solid_id, schema_name);
    end if;
    
    intern_delete_cityobject(bridge_rec.id, schema_name);
  exception
    when others then
  ...
  */
  ...
  is
  begin
    pre_del_bridge_thematic_srf(bridge_thematic_surface_rec, schema_name);
    execute immediate 'delete from ' || schema_name || '.bridge_thematic_surface where id=:1' using bridge_thematic_surface_rec.id;
    post_del_bridge_thematic_srf(bridge_thematic_surface_rec, schema_name);
  exception
    when others then
  ...
  begin
    if bridge_thematic_surface_rec.lod2_multi_surface_id is not null then
      intern_delete_surface_geometry(bridge_thematic_surface_rec.lod2_multi_surface_id, schema_name);
    end if;
    if bridge_thematic_surface_rec.lod3_multi_surface_id is not null then
      intern_delete_surface_geometry(bridge_thematic_surface_rec.lod3_multi_surface_id, schema_name);
    end if;
    if bridge_thematic_surface_rec.lod4_multi_surface_id is not null then
      intern_delete_surface_geometry(bridge_thematic_surface_rec.lod4_multi_surface_id, schema_name);
    end if;

    intern_delete_cityobject(bridge_thematic_surface_rec.id, schema_name);
  exception
    when others then
  ...
  */
  ...
  is
  begin
    execute immediate 'delete from ' || schema_name || '.bridge_installation where id=:1' using bridge_installation_rec.id;
  ...
  begin
    if bridge_installation_rec.lod2_brep_id is not null then
      intern_delete_surface_geometry(bridge_installation_rec.lod2_brep_id, schema_name);
    end if;
    if bridge_installation_rec.lod3_brep_id is not null then
      intern_delete_surface_geometry(bridge_installation_rec.lod3_brep_id, schema_name);
    end if;
    if bridge_installation_rec.lod4_brep_id is not null then
      intern_delete_surface_geometry(bridge_installation_rec.lod4_brep_id, schema_name);
    end if;

    intern_delete_cityobject(bridge_installation_rec.id, schema_name);
  exception
    when others then
  ...
  */
  ...
  is
  begin
    execute immediate 'delete from ' || schema_name || '.bridge_constr_element where id=:1' using bridge_constr_element_rec.id;
    post_del_bridge_constr_element(bridge_constr_element_rec, schema_name);
  exception
    when others then
  ...
  begin
    if bridge_constr_element_rec.lod2_brep_id is not null then
      intern_delete_surface_geometry(bridge_constr_element_rec.lod2_brep_id, schema_name);
    end if;
    if bridge_constr_element_rec.lod3_brep_id is not null then
      intern_delete_surface_geometry(bridge_constr_element_rec.lod3_brep_id, schema_name);
    end if;
    if bridge_constr_element_rec.lod4_brep_id is not null then
      intern_delete_surface_geometry(bridge_constr_element_rec.lod4_brep_id, schema_name);
    end if;

    intern_delete_cityobject(bridge_constr_element_rec.id, schema_name);
  exception
    when others then
  ...
  */
  ...
  begin
    ...
    execute immediate 'delete from ' || schema_name || '.bridge_room where id=:1' using bridge_room_rec.id;
  ...
  begin
    if bridge_room_rec.lod4_multi_surface_id is not null then
      intern_delete_surface_geometry(bridge_room_rec.lod4_multi_surface_id, schema_name);
    end if;
    if bridge_room_rec.lod4_solid_id is not null then
      intern_delete_surface_geometry(bridge_room_rec.lod4_solid_id, schema_name);
    end if;

    intern_delete_cityobject(bridge_room_rec.id, schema_name);
  exception
    when others then
  ...
  */
  ...
  is
  begin
    execute immediate 'delete from ' || schema_name || '.bridge_furniture where id=:1' using bridge_furniture_rec.id;
  ...
  begin
    if bridge_furniture_rec.lod4_brep_id is not null then
      intern_delete_surface_geometry(bridge_furniture_rec.lod4_brep_id, schema_name);
    end if;
    intern_delete_cityobject(bridge_furniture_rec.id, schema_name);
  exception
    when others then
  ...
  */
  ...
  begin
    ...
    execute immediate 'delete from ' || schema_name || '.bridge_opening where id=:1' using bridge_opening_rec.id;
  ...
  begin
    ...
    if bridge_opening_rec.lod4_multi_surface_id is not null then
      intern_delete_surface_geometry(bridge_opening_rec.lod4_multi_surface_id, schema_name);
    end if;
    ...
    intern_delete_cityobject(bridge_opening_rec.id, schema_name);
  exception
    when others then
  ...
  */
  ...
  begin
    ...
    execute immediate 'delete from ' || schema_name || '.tunnel where id=:1' using tunnel_rec.id;
  ...
  begin
    if tunnel_rec.lod1_multi_surface_id is not null then
      intern_delete_surface_geometry(tunnel_rec.lod1_multi_surface_id, schema_name);
    end if; 
    if tunnel_rec.lod2_multi_surface_id is not null then
      intern_delete_surface_geometry(tunnel_rec.lod2_multi_surface_id, schema_name);
    end if;
    if tunnel_rec.lod3_multi_surface_id is not null then
      intern_delete_surface_geometry(tunnel_rec.lod3_multi_surface_id, schema_name);
    end if;
    if tunnel_rec.lod4_multi_surface_id is not null then
      intern_delete_surface_geometry(tunnel_rec.lod4_multi_surface_id, schema_name);
    end if;

    if tunnel_rec.lod1_solid_id is not null then
      intern_delete_surface_geometry(tunnel_rec.lod1_solid_id, schema_name);
    end if; 
    if tunnel_rec.lod2_solid_id is not null then
      intern_delete_surface_geometry(tunnel_rec.lod2_solid_id, schema_name);
    end if;
    if tunnel_rec.lod3_solid_id is not null then
      intern_delete_surface_geometry(tunnel_rec.lod3_solid_id, schema_name);
    end if;
    if tunnel_rec.lod4_solid_id is not null then
      intern_delete_surface_geometry(tunnel_rec.lod4_solid_id, schema_name);
    end if;
    
    intern_delete_cityobject(tunnel_rec.id, schema_name);
  exception
    when others then
  ...
  */
  ...
  is
  begin
    pre_del_tunnel_thematic_srf(tunnel_thematic_surface_rec, schema_name);
    execute immediate 'delete from ' || schema_name || '.tunnel_thematic_surface where id=:1' using tunnel_thematic_surface_rec.id;
    post_del_tunnel_thematic_srf(tunnel_thematic_surface_rec, schema_name);
  exception
    when others then
  ...
  begin
    if tunnel_thematic_surface_rec.lod2_multi_surface_id is not null then
      intern_delete_surface_geometry(tunnel_thematic_surface_rec.lod2_multi_surface_id, schema_name);
    end if;
    if tunnel_thematic_surface_rec.lod3_multi_surface_id is not null then
      intern_delete_surface_geometry(tunnel_thematic_surface_rec.lod3_multi_surface_id, schema_name);
    end if;
    if tunnel_thematic_surface_rec.lod4_multi_surface_id is not null then
      intern_delete_surface_geometry(tunnel_thematic_surface_rec.lod4_multi_surface_id, schema_name);
    end if;

    intern_delete_cityobject(tunnel_thematic_surface_rec.id, schema_name);
  exception
    when others then
  ...
  */
  ...
  begin
    ...
    execute immediate 'delete from ' || schema_name || '.tunnel_opening where id=:1' using tunnel_opening_rec.id;
  ...
  begin
    if tunnel_opening_rec.lod3_multi_surface_id is not null then
      intern_delete_surface_geometry(tunnel_opening_rec.lod3_multi_surface_id, schema_name);
    end if;
    if tunnel_opening_rec.lod4_multi_surface_id is not null then
      intern_delete_surface_geometry(tunnel_opening_rec.lod4_multi_surface_id, schema_name);
    end if;

    intern_delete_cityobject(tunnel_opening_rec.id, schema_name);
  exception
    when others then
  ...
  */
  ...
  is
  begin
    execute immediate 'delete from ' || schema_name || '.tunnel_furniture where id=:1' using tunnel_furniture_rec.id;
  ...
  begin
    if tunnel_furniture_rec.lod4_brep_id is not null then
      intern_delete_surface_geometry(tunnel_furniture_rec.lod4_brep_id, schema_name);
    end if;
    intern_delete_cityobject(tunnel_furniture_rec.id, schema_name);
  exception
    when others then
  ...
  */
  ...
  is
  begin
    execute immediate 'delete from ' || schema_name || '.tunnel_installation where id=:1' using tunnel_installation_rec.id;
  ...
  begin
    if tunnel_installation_rec.lod2_brep_id is not null then
      intern_delete_surface_geometry(tunnel_installation_rec.lod2_brep_id, schema_name);
    end if;
    if tunnel_installation_rec.lod3_brep_id is not null then
      intern_delete_surface_geometry(tunnel_installation_rec.lod3_brep_id, schema_name);
    end if;
    if tunnel_installation_rec.lod4_brep_id is not null then
      intern_delete_surface_geometry(tunnel_installation_rec.lod4_brep_id, schema_name);
    end if;

    intern_delete_cityobject(tunnel_installation_rec.id, schema_name);
  exception
    when others then
  ...
  */
  ...
  is
  begin
    pre_del_tunnel_hollow_space(tunnel_hollow_space_rec, schema_name);
    execute immediate 'delete from ' || schema_name || '.tunnel_hollow_space where id=:1' using tunnel_hollow_space_rec.id;
    post_del_tunnel_hollow_space(tunnel_hollow_space_rec, schema_name);
  exception
    when others then
  ...
  begin
    if tunnel_hollow_space_rec.lod4_multi_surface_id is not null then
      intern_delete_surface_geometry(tunnel_hollow_space_rec.lod4_multi_surface_id, schema_name);
    end if;
    if tunnel_hollow_space_rec.lod4_solid_id is not null then
      intern_delete_surface_geometry(tunnel_hollow_space_rec.lod4_solid_id, schema_name);
    end if;

    intern_delete_cityobject(tunnel_hollow_space_rec.id, schema_name);
  exception
    when others then
  ...
  */  
  ...
  is
  begin
    intern_delete_surface_geometry(pid, schema_name);
  ...
  is
  begin
    execute immediate 'delete from ' || schema_name || '.external_reference where id=:1' using pid;
  exception
    when no_data_found then
      return;
    when others then
  ...
  exception
    when no_data_found then
      ...
      intern_delete_cityobject(pid, schema_name);
      return;
    when others then
  ...
  begin
    ...
    delete_building(building_rec, schema_name);
  exception
    when no_data_found then
      return;
    when others then
  ...
  begin
    ...
    delete_city_furniture(city_furniture_rec, schema_name);
  exception
    when no_data_found then
      return;
    when others then
  ...
  begin
    ...
    delete_generic_cityobject(generic_cityobject_rec, schema_name);
  exception
    when no_data_found then
      return;
    when others then
  ...
  begin
    ...
    delete_land_use(land_use_rec, schema_name);
  exception
    when no_data_found then
      return;
    when others then
  ...
  begin
    ...
    delete_plant_cover(plant_cover_rec, schema_name);
  exception
    when no_data_found then
      return;
    when others then
  ...
  begin
    ...
    delete_solitary_veg_obj(solitary_veg_obj_rec, schema_name);
  exception
    when no_data_found then
      return;
    when others then
  ...
  begin
    ...
    delete_transport_complex(transport_complex_rec, schema_name);
  exception
    when no_data_found then
      return;
    when others then
  ...
  begin
    ...
    delete_waterbody(waterbody_rec, schema_name);
  exception
    when no_data_found then
      return;
    when others then
  ...
  begin
    ...
    delete_waterbnd_surface(waterbnd_surface_rec, schema_name);
  exception
    when no_data_found then
      return;
    when others then
  ...
  begin
    ...
    delete_relief_feature(relief_feature_rec, schema_name);
  exception
    when no_data_found then
      return;
    when others then
  ...
  begin
    ...
    delete_relief_component(relief_component_rec, schema_name);
  exception
    when no_data_found then
      return;
    when others then
  ...
  begin
    ...
    delete_tin_relief(tin_relief_rec, schema_name);
  exception
    when no_data_found then
      return;
    when others then
  ...
  begin
    ...
    delete_masspoint_relief(masspoint_relief_rec, schema_name);
  exception
    when no_data_found then
      return;
    when others then
  ...
  begin
    ...
    delete_breakline_relief(breakline_relief_rec, schema_name);
  exception
    when no_data_found then
      return;
    when others then
  ...
  begin
    ...
    delete_raster_relief(raster_relief_rec, schema_name);
  exception
    when no_data_found then
      return;
    when others then
  ...
  begin
    ...
    delete_bridge(bridge_rec, schema_name);
  exception
    when no_data_found then
      return;
    when others then
  ...
  begin
    ...
    delete_tunnel(tunnel_rec, schema_name);
  exception
    when no_data_found then
      return;
    when others then
  ...
  */
  ...
  begin
    ...
    case 
      when objectclass_id = 4 then delete_land_use(pid, schema_name);
      when objectclass_id = 5 then delete_generic_cityobject(pid, schema_name);
      when objectclass_id = 7 then delete_solitary_veg_obj(pid, schema_name);
      when objectclass_id = 8 then delete_plant_cover(pid, schema_name);
      when objectclass_id = 9 then delete_waterbody(pid, schema_name);
      when objectclass_id = 11 or 
           objectclass_id = 12 or 
           objectclass_id = 13 then delete_waterbnd_surface(pid, schema_name);
      when objectclass_id = 14 then delete_relief_feature(pid, schema_name);
      ...
      when objectclass_id = 27 or 
           objectclass_id = 28 then delete_building_installation(pid, schema_name);
      when objectclass_id = 30 or 
           ...
           objectclass_id = 36 then delete_thematic_surface(pid, schema_name);
      when objectclass_id = 38 or 
           objectclass_id = 39 then delete_opening(pid, schema_name);
      when objectclass_id = 40 then delete_building_furniture(pid, schema_name);
      when objectclass_id = 41 then delete_room(pid, schema_name);
      ...
      when objectclass_id = 63 or 
           objectclass_id = 64 then delete_bridge(pid, schema_name);
      when objectclass_id = 65 or 
           objectclass_id = 66 then delete_bridge_installation(pid, schema_name);
      when objectclass_id = 68 or 
           ...
           objectclass_id = 76 then delete_bridge_thematic_surface(pid, schema_name);
      when objectclass_id = 78 or 
           objectclass_id = 79 then delete_bridge_opening(pid, schema_name);
      when objectclass_id = 80 then delete_bridge_furniture(pid, schema_name);
      when objectclass_id = 81 then delete_bridge_room(pid, schema_name);
      when objectclass_id = 82 then delete_bridge_constr_element(pid, schema_name);
      when objectclass_id = 84 or 
           objectclass_id = 85 then delete_tunnel(pid, schema_name);
      when objectclass_id = 86 or 
           objectclass_id = 87 then delete_tunnel_installation(pid, schema_name);
      when objectclass_id = 89 or 
           ...
           objectclass_id = 97 then delete_tunnel_thematic_surface(pid, schema_name);
      when objectclass_id = 99 or 
           objectclass_id = 100 then delete_tunnel_opening(pid, schema_name);
      when objectclass_id = 101 then delete_tunnel_furniture(pid, schema_name);
      when objectclass_id = 102 then delete_tunnel_hollow_space(pid, schema_name);
      else
        -- do nothing
        null;
    end case;
  ...
  -- NOTE: all constraints have to be set to ON DELETE CASCADE (function: geodb_util.update_schema_constraints)
  procedure delete_cityobject_cascade(pid number, schema_name varchar2 := USER)
  is
  begin  
    -- first step: delete local appearance
    execute immediate 'select delete_appearance(id) from ' || schema_name || '.appearance where cityobject_id = :1' using pid;
  
    -- second step: delete geometries
    execute immediate 'delete from ' || schema_name || '.surface_geometry where cityobject_id = :1 and parent_id is null' using pid;
