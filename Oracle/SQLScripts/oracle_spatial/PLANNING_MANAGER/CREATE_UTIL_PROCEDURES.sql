...
/*
 * Die Prozedur pr�ft, ob die Planungen mit der gegeben ID existiert, und ob sie
 * beendet ist.
 *
...
/*
 * Die Prozedur pr�ft, ob die Planungsalternative mit der gegeben ID existiert,
...
/*
 * Die Prozedur pr�ft, ob der CityModelAspect mit der gegeben ID existiert
 *
