...
BEGIN
  ...
  citydb_constraint.set_fkey_delete_rule('cityobject_member_fk1', 'cityobject_member', 'citymodel_id', 'citymodel', 'id', 'c', USER);
  citydb_constraint.set_fkey_delete_rule('general_cityobject_fk', 'generalization', 'cityobject_id', 'cityobject', 'id', 'c', USER);
  citydb_constraint.set_fkey_delete_rule('general_generalizes_to_fk', 'generalization', 'generalizes_to_id', 'cityobject', 'id', 'c', USER);
  citydb_constraint.set_fkey_delete_rule('group_to_cityobject_fk', 'group_to_cityobject', 'cityobject_id', 'cityobject', 'id', 'c', USER);
  citydb_constraint.set_fkey_delete_rule('group_to_cityobject_fk1', 'group_to_cityobject', 'cityobjectgroup_id', 'cityobjectgroup', 'id', 'c', USER);
