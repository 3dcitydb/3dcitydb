...
CREATE INDEX CITYOBJECT_ENVELOPE_SPX ON CITYOBJECT (ENVELOPE) INDEXTYPE IS MDSYS.SPATIAL_INDEX PARALLEL;
...
CREATE INDEX SURFACE_GEOM_SOLID_SPX ON SURFACE_GEOMETRY (SOLID_GEOMETRY) INDEXTYPE IS MDSYS.SPATIAL_INDEX PARAMETERS ('sdo_indx_dims=3') PARALLEL;

CREATE INDEX SURFACE_GEOM_SPX ON SURFACE_GEOMETRY (GEOMETRY) INDEXTYPE IS MDSYS.SPATIAL_INDEX PARALLEL;
