...
CREATE INDEX APPEARANCE_INX ON APPEARANCE (GMLID);
...
CREATE INDEX CITYMODEL_INX ON CITYMODEL (GMLID);

CREATE INDEX CITYOBJECT_INX ON CITYOBJECT (GMLID);
...
CREATE INDEX SURFACE_DATA_INX ON SURFACE_DATA (GMLID);
...
CREATE INDEX SURFACE_GEOM_INX ON SURFACE_GEOMETRY (GMLID);
