...
AS
  ...
  BEGIN
    ...
    CREATE TABLE citymodel 
      AS SELECT
        ID, GMLID, GMLID_CODESPACE, NAME, NAME_CODESPACE, DESCRIPTION, ENVELOPE, 
  ...
  BEGIN
    ...
    EXECUTE IMMEDIATE 'CREATE TABLE building 
	  AS 
	  SELECT  
	    ID, BUILDING_PARENT_ID, BUILDING_ROOT_ID, replace(CLASS,'' '',''--/\--'') as CLASS, 
	    CAST(null AS VARCHAR2(4000)) as CLASS_CODESPACE, replace(FUNCTION,'' '',''--/\--'') as FUNCTION, 
	    CAST(null AS VARCHAR2(4000)) as FUNCTION_CODESPACE, replace(USAGE,'' '',''--/\--'') AS USAGE, 
    ...
    EXECUTE IMMEDIATE 'update cityobject c
			...
			(select b.name, b.name_codespace, b.description from building_v2 b
			 where b.id = c.id) 
			where exists
			(select * from building_v2 b
			 where b.id = c.id)';
  ...
  BEGIN
    ...
    CREATE TABLE room 
	AS
	SELECT ID, CAST(replace(r.CLASS,'' '',''--/\--'') AS VARCHAR2(256)) AS CLASS, 
	      CAST(null AS VARCHAR2(4000)) as CLASS_CODESPACE,   
	      CAST(replace(r.FUNCTION,'' '',''--/\--'') AS VARCHAR2(1000)) AS FUNCTION,      
	      CAST(null AS VARCHAR2(4000)) as FUNCTION_CODESPACE,         
	      CAST(replace(r.USAGE,'' '',''--/\--'') AS VARCHAR2(1000)) AS USAGE,     
    ...
    EXECUTE IMMEDIATE 'update cityobject c
			set (c.name,c.name_codespace,c.description) = 
			(select r.name, r.name_codespace, r.description from room_v2 r
			 where r.id = c.id) 
			where exists
			(select * from room_v2 r
			 where r.id = c.id)';
  ...
  BEGIN
	...
	AS 
	SELECT ID, CAST(replace(CLASS,'' '',''--/\--'') AS VARCHAR2(256)) AS CLASS, 
		CAST(null AS VARCHAR2(4000)) as CLASS_CODESPACE,   
		CAST(replace(FUNCTION,'' '',''--/\--'') AS VARCHAR2(1000)) AS FUNCTION,      
		CAST(null AS VARCHAR2(4000)) as FUNCTION_CODESPACE,         
		CAST(replace(USAGE,'' '',''--/\--'') AS VARCHAR2(1000)) AS USAGE,     
		CAST(null AS VARCHAR2(4000)) as USAGE_CODESPACE,    
    ...
    EXECUTE IMMEDIATE 'update cityobject c
			set (c.name,c.name_codespace,c.description) = 
			(select b.name, b.name_codespace, b.description from building_furniture_v2 b
			 where b.id = c.id) 
			where exists
			(select * from building_furniture_v2 b
			 where b.id = c.id)';
  ...
  BEGIN
	...
	CREATE TABLE building_installation 
	  ...
	  SELECT ID,   
	    ...
	    CAST(replace(CLASS,'' '',''--/\--'') AS VARCHAR2(256)) AS CLASS, 
	    CAST(null AS VARCHAR2(4000)) as CLASS_CODESPACE,   
	    CAST(replace(FUNCTION,'' '',''--/\--'') AS VARCHAR2(1000)) AS FUNCTION,      
	    CAST(null AS VARCHAR2(4000)) as FUNCTION_CODESPACE,         
	    CAST(replace(USAGE,'' '',''--/\--'') AS VARCHAR2(1000)) AS USAGE,     
    ...
    EXECUTE IMMEDIATE 'update cityobject c
			set (c.name,c.name_codespace,c.description) = 
			(select b.name, b.name_codespace, b.description from building_installation_v2 b
			 where b.id = c.id) 
			where exists
			(select * from building_installation_v2 b
			 where b.id = c.id)';
  ...
  BEGIN
    ...
    EXECUTE IMMEDIATE 'update cityobject c
			set (c.name,c.name_codespace,c.description) = 
			(select cf.name, cf.name_codespace, cf.description from city_furniture_v2 cf
			 where cf.id = c.id) 
			where exists
  ...
  BEGIN
    ...
    EXECUTE IMMEDIATE 'update cityobject c
			set (c.name,c.name_codespace,c.description) = 
			(select co.name, co.name_codespace, co.description from cityobjectgroup_v2 co
			 where co.id = c.id) 
			where exists
  ...
  BEGIN
    ...
    EXECUTE IMMEDIATE 'update cityobject c
			set (c.name,c.name_codespace,c.description) = 
			(select g.name, g.name_codespace, g.description from generic_cityobject_v2 g
			 where g.id = c.id) 
			where exists
			(select * from generic_cityobject_v2 g
			 where g.id = c.id)';
  ...
  BEGIN
    ...
    EXECUTE IMMEDIATE 'update cityobject c
			set (c.name,c.name_codespace,c.description) = 
			(select l.name, l.name_codespace, l.description from land_use_v2 l
			 where l.id = c.id) 
			where exists
			(select * from land_use_v2 l
			 where l.id = c.id)';
  ...
  BEGIN
    ...
    EXECUTE IMMEDIATE 'update cityobject c
			set (c.name,c.name_codespace,c.description) = 
			(select o.name, o.name_codespace, o.description from opening_v2 o
			 where o.id = c.id) 
			where exists
			(select * from opening_v2 o
			 where o.id = c.id)';
  ...
  BEGIN
    ...
    EXECUTE IMMEDIATE 'update cityobject c
			set (c.name,c.name_codespace,c.description) = 
			(select t.name, t.name_codespace, t.description from thematic_surface_v2 t
			 where t.id = c.id) 
			where exists
			(select * from thematic_surface_v2 t
			 where t.id = c.id)';  
  ...
  BEGIN
    ...
    EXECUTE IMMEDIATE 'update cityobject c
			set (c.name,c.name_codespace,c.description) = 
			(select p.name, p.name_codespace, p.description from plant_cover_v2 p
			 where p.id = c.id) 
			where exists
			(select * from plant_cover_v2 p
			 where p.id = c.id)';    
  ...
  BEGIN
    ...
    EXECUTE IMMEDIATE 'update cityobject c
			set (c.name,c.name_codespace,c.description) = 
			(select r.name, r.name_codespace, r.description from relief_component_v2 r
			 where r.id = c.id) 
			where exists
  ...
  BEGIN
    ...
    EXECUTE IMMEDIATE 'update cityobject c
			set (c.name,c.name_codespace,c.description) = 
			(select r.name, r.name_codespace, r.description from relief_feature_v2 r
			 where r.id = c.id) 
			where exists
  ...
  BEGIN
    ...
    EXECUTE IMMEDIATE 'update cityobject c
			set (c.name,c.name_codespace,c.description) = 
			(select sv.name, sv.name_codespace, sv.description from solitary_vegetat_object_v2 sv
			 where sv.id = c.id) 
			where exists
			(select * from solitary_vegetat_object_v2 sv
			 where sv.id = c.id)';    
  ...
  BEGIN
    ...
    EXECUTE IMMEDIATE 'update cityobject c
			set (c.name,c.name_codespace,c.description) = 
			(select t.name, t.name_codespace, t.description from traffic_area_v2 t
			 where t.id = c.id) 
			where exists
			(select * from traffic_area_v2 t
			 where t.id = c.id)';
  ...
  BEGIN
    ...
    EXECUTE IMMEDIATE 'update cityobject c
			set (c.name,c.name_codespace,c.description) = 
			(select t.name, t.name_codespace, t.description from transportation_complex_v2 t
			 where t.id = c.id) 
			where exists
			(select * from transportation_complex_v2 t
			 where t.id = c.id)';
  ...
  BEGIN
    ...
    EXECUTE IMMEDIATE 'update cityobject c
			set (c.name,c.name_codespace,c.description) = 
			(select w.name, w.name_codespace, w.description from waterbody_v2 w
			 where w.id = c.id) 
			where exists
			(select * from waterbody_v2 w
			 where w.id = c.id)';
  ...
  BEGIN
    ...
    EXECUTE IMMEDIATE 'update cityobject c
			set (c.name,c.name_codespace,c.description) = 
			(select w.name, w.name_codespace, w.description from waterboundary_surface_v2 w
			 where w.id = c.id) 
			where exists
			(select * from waterboundary_surface_v2 w
			 where w.id = c.id)';
