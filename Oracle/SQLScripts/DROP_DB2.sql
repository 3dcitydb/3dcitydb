...
ALTER TABLE AGGREGATION_INFO DROP CONSTRAINT "AGGREGATION_INFO_FK1";
ALTER TABLE AGGREGATION_INFO DROP CONSTRAINT "AGGREGATION_INFO_FK2";
...
ALTER TABLE GENERIC_CITYOBJECT DROP CONSTRAINT "GEN_OBJECT_LOD4BREP_FK";
...
DROP TABLE AGGREGATION_INFO CASCADE CONSTRAINTS;
