...
--DROP SEQUENCE IF EXISTS namespace;
...
--CREATE SEQUENCE namespace START WITH 1 INCREMENT BY 1 MINVALUE 0 MAXVALUE 9223372036854775807 CACHE 20 NOCYCLE;
...
--
-- Create triggers to insert ID values using sequences
--

CREATE OR REPLACE TRIGGER codelist_entry_bi_trg
  BEFORE INSERT ON codelist_entry
  FOR EACH ROW
BEGIN
  :new.id := codelist_entry_seq.nextval;
END;
/