...
AS
  ...
  FUNCTION get_coord_ref_sys_info (p_srid IN INTEGER, p_coord_ref_sys_name OUT VARCHAR2, p_coord_ref_sys_kind OUT VARCHAR2, p_wktext OUT VARCHAR2);
...
AS
  ...
  ******************************************************************/
  ...
  BEGIN
    ...
    EXECUTE IMMEDIATE 'INSERT INTO database_srs (srid, gml_srs_name) VALUES (:1, :2)' USING p_schema_srid, p_schema_gml_srs_name;
