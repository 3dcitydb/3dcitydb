...
\echo
\echo 'Revoking read-only priviliges on schema "':SCHEMA_NAME'" from user "':RO_USERNAME'" ...' 

REVOKE SELECT ON ALL TABLES IN SCHEMA :"SCHEMA_NAME" FROM :"RO_USERNAME";
REVOKE USAGE ON SCHEMA :"SCHEMA_NAME" FROM :"RO_USERNAME";
