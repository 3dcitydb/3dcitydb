...
CREATE TABLE public.city_furniture(
	...
	lod1_terrain_intersection geometry(MULTILINESTRINGZ,:SRSNO),
	lod2_terrain_intersection geometry(MULTILINESTRINGZ,:SRSNO),
	lod3_terrain_intersection geometry(MULTILINESTRINGZ,:SRSNO),
	lod4_terrain_intersection geometry(MULTILINESTRINGZ,:SRSNO),
	lod1_brep_id integer,
	lod2_brep_id integer,
	lod3_brep_id integer,
	lod4_brep_id integer,
	lod1_other_geom geometry(GEOMETRYZ,:SRSNO),
...
CREATE TABLE public.generic_cityobject(
	...
	usage character varying(1000),
	usage_codespace character varying(4000),
	lod0_terrain_intersection geometry(MULTILINESTRINGZ,:SRSNO),
	lod1_terrain_intersection geometry(MULTILINESTRINGZ,:SRSNO),
	lod2_terrain_intersection geometry(MULTILINESTRINGZ,:SRSNO),
	lod3_terrain_intersection geometry(MULTILINESTRINGZ,:SRSNO),
	lod4_terrain_intersection geometry(MULTILINESTRINGZ,:SRSNO),
	...
	lod3_brep_id integer,
	lod4_brep_id integer,
	lod0_other_geom geometry(GEOMETRYZ,:SRSNO),
	lod1_other_geom geometry(GEOMETRYZ,:SRSNO),
	lod2_other_geom geometry(GEOMETRYZ,:SRSNO),
	lod3_other_geom geometry(GEOMETRYZ,:SRSNO),
	lod4_other_geom geometry(GEOMETRYZ,:SRSNO),
...
CREATE TABLE public.building(
	...
	lod3_terrain_intersection geometry(MULTILINESTRINGZ,:SRSNO),
	lod4_terrain_intersection geometry(MULTILINESTRINGZ,:SRSNO),
	lod2_multi_curve geometry(MULTILINESTRINGZ,:SRSNO),
	lod3_multi_curve geometry(MULTILINESTRINGZ,:SRSNO),
	lod4_multi_curve geometry(MULTILINESTRINGZ,:SRSNO),
...
CREATE TABLE public.breakline_relief(
	id integer NOT NULL,
	ridge_or_valley_lines geometry(MULTILINESTRINGZ,:SRSNO),
	break_lines geometry(MULTILINESTRINGZ,:SRSNO),
...
CREATE TABLE public.tin_relief(
	...
	stop_lines geometry(MULTILINESTRINGZ,:SRSNO),
	break_lines geometry(MULTILINESTRINGZ,:SRSNO),
...
CREATE TABLE public.waterbody(
	...
	usage character varying(1000),
	usage_codespace character varying(4000),
	lod0_multi_curve geometry(MULTILINESTRINGZ,:SRSNO),
	lod1_multi_curve geometry(MULTILINESTRINGZ,:SRSNO),
	lod0_multi_surface_id integer,
	lod1_multi_surface_id integer,
	lod1_solid_id integer,
	lod2_solid_id integer,
...
CREATE TABLE public.implicit_geometry(
	...
	relative_other_geom geometry(GEOMETRYZ,:SRSNO),
...
CREATE TABLE public.surface_geometry(
	...
	solid_geometry geometry(GEOMETRYZ,:SRSNO),
	cityobject_id integer,
