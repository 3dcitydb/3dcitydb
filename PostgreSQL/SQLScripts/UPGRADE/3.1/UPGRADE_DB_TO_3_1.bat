...
REM on PostgreSQL/PostGIS to version 3.1
...
REM Run UPGRADE_DB_TO_3_1.sql to upgrade the 3D City Database instance
"%PGBIN%\psql" -d "%CITYDB%" -t -f "UPGRADE_DB_TO_3_1.sql"
