...
REM on PostgreSQL/PostGIS to version 3.2
...
REM Run UPGRADE_DB_3_1_TO_3_2.sql to upgrade the 3D City Database instance
"%PGBIN%\psql" -d "%CITYDB%" -t -f "UPGRADE_DB_3_1_TO_3_2.sql"
