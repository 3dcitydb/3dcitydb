...
BEGIN
  ...
  -- delete city object
  PERFORM geodb_pkg.intern_delete_cityobject(lu_id, schema_name);
...
BEGIN
  ...
  -- delete city object
  PERFORM geodb_pkg.intern_delete_cityobject(pc_id, schema_name);
...
BEGIN
  ...
  -- delete city object
  PERFORM geodb_pkg.intern_delete_cityobject(wb_id, schema_name);
...
BEGIN
  ...
  -- delete city object
  PERFORM geodb_pkg.intern_delete_cityobject(wbs_id, schema_name);
...
BEGIN
  ...
  -- delete city object
  PERFORM geodb_pkg.intern_delete_cityobject(rf_id, schema_name);
...
BEGIN
  ...
  -- delete component
  PERFORM geodb_pkg.delete_masspoint_relief(rc_id, schema_name);
  PERFORM geodb_pkg.delete_breakline_relief(rc_id, schema_name);
  PERFORM geodb_pkg.delete_tin_relief(rc_id, schema_name);
  PERFORM geodb_pkg.delete_raster_relief(rc_id, schema_name);
  ...
  --// POST DELETE RELIEF FEATURE //--
  -- delete city object
  PERFORM geodb_pkg.intern_delete_cityobject(rc_id, schema_name);
...
BEGIN
  ...
  -- delete city object
  PERFORM geodb_pkg.intern_delete_cityobject(cog_id, schema_name);
...
BEGIN
  ...
  -- delete city object
  PERFORM geodb_pkg.intern_delete_cityobject(b_id, schema_name);
...
BEGIN
  ...
  -- delete city object
  PERFORM geodb_pkg.intern_delete_cityobject(ts_id, schema_name);
...
BEGIN
  ...
  -- delete city object
  PERFORM geodb_pkg.intern_delete_cityobject(r_id, schema_name);
...
BEGIN
  ...
  -- delete city object
  PERFORM geodb_pkg.intern_delete_cityobject(tc_id, schema_name);
...
BEGIN
  ...
  -- delete city object
  PERFORM geodb_pkg.intern_delete_cityobject(ta_id, schema_name);
...
BEGIN
  ...
  -- delete city object
  PERFORM geodb_pkg.intern_delete_cityobject(brd_id, schema_name);
...
BEGIN
  ...
  -- delete city object
  PERFORM geodb_pkg.intern_delete_cityobject(brdts_id, schema_name);
...
BEGIN
  ...
  -- delete city object
  PERFORM geodb_pkg.intern_delete_cityobject(brdr_id, schema_name);
...
BEGIN
  ...
  -- delete city object
  PERFORM geodb_pkg.intern_delete_cityobject(tun_id, schema_name);
...
BEGIN
  ...
  -- delete city object
  PERFORM geodb_pkg.intern_delete_cityobject(tunts_id, schema_name);
...
BEGIN
  ...
  -- delete city object
  PERFORM geodb_pkg.intern_delete_cityobject(tunhs_id, schema_name);
