...
DELETE_RASTER_FILE=SCHEMA/RASTER/DELETE_RASTER.sql
...
ENVELOPE_RASTER_FILE=SCHEMA/RASTER/ENVELOPE_RASTER.sql
TMP_ENVELOPE_RASTER_FILE=TMP_${SCHEMA_NAME}_ENVELOPE_RASTER.sql
SCHEMA_RASTER_FILE=SCHEMA/RASTER/SCHEMA_RASTER.sql
CREATE_DB_RASTER_FILE=../../CREATE_DB_RASTER.sql
TMP_CREATE_DB_RASTER_FILE=TMP_${SCHEMA_NAME}_CREATE_DB_RASTER.sql
...
sed 's#'$SCHEMA_RASTER_FILE'#../../'$SCHEMA_RASTER_FILE'#g;s#'$DELETE_RASTER_FILE'#'$TMP_DELETE_RASTER_FILE'#g;s#'$ENVELOPE_RASTER_FILE'#'$TMP_ENVELOPE_RASTER_FILE'#g' $CREATE_DB_RASTER_FILE > $TMP_CREATE_DB_RASTER_FILE
echo 'Done.'
...
rm -f $TMP_CREATE_DB_RASTER_FILE
